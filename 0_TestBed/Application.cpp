...
void ApplicationClass::InitUserAppVariables()
{
	...
	m_pMeshMngr->LoadModelUnthreaded("Minecraft\\MC_Cow.obj", "Cow", glm::translate(vector3(-4.0f, 0.0f, 0.0f)));
	m_pMeshMngr->LoadModelUnthreaded("Minecraft\\MC_Zombie.obj", "Zombie", glm::translate(vector3(-2.0f, 0.0f, 0.0f)));
	m_pMeshMngr->LoadModelUnthreaded("Minecraft\\MC_Steve.obj", "Steve", glm::translate(vector3( 2.0f, 0.0f, 0.0f)));
	m_pMeshMngr->LoadModelUnthreaded("Minecraft\\MC_Pig.obj", "Pig", glm::translate(vector3(4.0f, 0.0f, 0.0f)));
